...
//     content: `<p>Looks like I've entered another rough patch. Couldn't get much coding done today other than catching up with one of my weekend Javascript class lectures. The class was an introduction to React, why it's so popular and what are its benefits. To sum things up, React makes dom manipulation easier by handling it all for you. This is done by writing our code as a State (the variables) and the Components (the hardcoded layouts/blueprints). So react will automatically update the State of the Component, if we simply just change the value of a particular state. States are usually stored like objects, much like JSON so pretty familiar ground.<br><br>Today's day was also particularly note-worthy because I came across an inner sentiment for the first time. So basically me and a friend were discussing about how unnecessary vaping and smoking is (in context of college) and I was telling her how I despise it. I went on to tell her of how once someone vaped in front of me and the smoke came in my face and how I coughed straight at them. She found this a bit strange and unnecessary on my part which is when I, without any thought, told her that "I want live long enough to see my grand-daughter get married". This was a completely involuntary response and put me into deep thought. It was something which came to me naturally and the more I thought about it, it seemed like a good enough reason to sacrifice on comfort right now to live those extra few years. Before you start contemplating that I'm thinking on extreme parallels, let me assure you I'm not. Something like this hasn't happened that often with me and I'd like to belive that it did for a reason. To make this a reality, I will start swimming daily from tomorrow and will in a couple of weeks start hitting the gym as well, now that I have good reason to. So dear reader let me leave you by restating that <br><i>"I want to live long enough to dance at my grand-daughter's wedding."</i></p>`,
//   },

//   {
//     id: 28,
//     dateStr: `9<sup>th</sup> October '24`,
//     content: `<p>A super tiring day indeed. Like any other day even today's day was full of college classes (3 in total) and driving lessons in the evening. However today I decided to drive upto college. Given the fact that my driving test is on the 11<sup>th</sup> of October, I decided to drive all the way to college to get as much experience under my belt. This wasn't as tiring as I expected, but in someways it was. Today out of 3 classes we had 2 practicals and 1 theory lecture. The chemistry practical was a fun one because I got to do titration (one of my favourite experiments) and also had to heat coal in an oven to calculate it's moisture content. The other part of the day was full of programming.<br><br> So we had one programming practical after which we had a programming lecture. In all this was 4 hours of programming (on paper) out of which I would've coded for like an hour and a half. This included writing code during my practicals and then writing code on paper during the lecture for the problem statements we were given and debugging code which my friends had written. I also worked on a potential project idea for a website and designed some part of it on paper. This included making a rough UI for the landing page, login/signup page and main content. I also made a rough structure of the schema and all the external libraries which will be needed for this project. One of the libraries I will be needing is called email.js and I'll probably need another one for sms based otp authentication. I also made my railway pass today and drove for an hour in the evening.<br><br>So all in all a pretty jam packed day, and I'm slightly disappointed in not being able to code at home, but like I say always, I can't wait to do better tomorrow.</p>`,
//   },

//   {
//     id: 29,
//     dateStr: `10<sup>th</sup> October '24`,
//     content: `<p>I keep saying "I'll maximise tomorrow" but sometimes the rough patch just sticks along. Today was nevertheless a super productive and fun day (college wise). Just like last week, each Thursday is practical day. So we have our electronics lab ,mechanics lab and workshop. Last week out of these two, electronics was the annoying one but today it wasn't. I managed to score a 7/7 in one test and a 4/7 (silly mistakes) on another. To sweeten the lab I even got full marks for my practical performance, so based on these numbers, this lab was a success. Likewise, workshop was also a hit. We were tasked with cutting the unused part of our metal pieces using a HACKSAW. This seemed pretty daunting to all of us given the fact that we had to do everything from scratch. This meant replacing the old blade with a new sharper one, tightening the blade, making sure it doesn't snap, literally placing our thumb against the blade while sawing away (initially) and doing all this twice! The experience was rewarding and fun though, and to once again sweeten the deal, I was the only one who finished both my metal pieces, cut them properly (like straightly) pulled all this off before anyone else and naturally managed to impress my sir. I really won't get into the details of the mechanics lab, just that we were told to chew off more than we could swallow and it all ended in chaos, thankfully I managed to just make things work here too.<br><br>So taking all that into account you can assume what a hectic day I would've had. If you take into account running to catch my train before it departs (I didn't chase a moving train), driving when I got back home and trying to code, try imagining just how packed all this would be. So for the coding part of the day I identified a library I can use for sending mails (nodemailer) and a protocol to facilitate it (SMTP). I really underestimated the effort it takes to automate sending mails. I just assumed that one library would handle it for you, but apparently we need to work with SMTP with mail providers like gmail, outlook etc. Even though reading documentation counts as coding, I did code today other than that. I coded my programming class (college) assignments (yes again) because I clearly wasn't in any headspace to work on something new or learn something new (mail protocols were already more than enough).<br><br>So yes I do wish this slump ends tomorrow, because tomorrow I won't be going to college, because tomorrow I take my driver's license test!!! I have manifested this for as long as I can remember, being able to drive on my own with confidence and a sense of owning the road (while giving others space) just seems surreal. This is mostly because of that thing I have with wanting absolute control with things. Being able to control your vehicle in an environment of absolute chaos they call traffic, dealing with several unpredictable variables, just makes me value that "control" even more. So I take my driver's license test tomorrow and just like yesterday, as practice, I drove to college today as well. Me and my dad took a different path this time though, one which went through all parts of Bandra and obviously the Mount Mary Church. I said a small prayer in front of the chapel as we halted and at the back of my head tried shouting it out so that it doesn't go unanswered. I'm certain it'll come true, because faith is all I have and is all thats has kept me going.</p>`,
//   },

//   {
//     id: 30,
//     dateStr: `11<sup>th</sup> October '24`,
//     content: `<p>I GOT MY DRIVERS LICENSE!!!! Today was the day of the drivers license test and I'm glad to report on having passed it without any hiccups. I did drive all the way to the test site and honestly more than the test, it was the drive till there which was stressful. Since I left at 9am, the roads were jam packed and I could barely take my foot off of the brake. This made the test seem like a cakewalk and it quite literally was. I then proceeded to close one of my bank accounts to consolidate all my financials in one bank account. All this work was done by 1pm after which I came home and just fell asleep.<br><br>On waking up I knew it was high time to code and I got down to business. I did start learning about the Number Object (through my udemy course) and learnt about the different methods to round numbers, toFixed method to get values upto a certain decimal place and about a parseInt method. This one piqued my interest because it gets numbers from strings having both characters and numbers as long as the numbers are placed before the character.<br><br>I'm writing this blog from my car because I couldn't do much work at home. This was due to the fact that I overslept, talked to my cousin and more importantly made an ordered list of priorities I need to stick to. Lately I've been pretty bad at managing time and this list is an attempt to be better at it. In order to stick to this list I needed to sleep at 9pm tonight but being the last day of Navratri I had to go to the murti pandal with my family. I tried hard to stick to my plan but on seeing my family's plan collapse due to me I eventually gave in. This is the reason I'm writing this blog from my car and the reason I'm determined never to give in. Today is the last day I'm compromising my own plans for someone else's (even though they're my family) and a reminder to give myself and my plans the most priority. This is day 30 of 100 and I'm Arya Idnani, here to win not to impress.</p>`,
//   },

//   {
//     id: 31,
//     dateStr: `12<sup>th</sup> October '24`,
//     content: `<p>Today didn't go as planned but went as expected, let me explain. I planned yesterday to set a new cycle into motion from today and had to sleep for it around 9pm last night, however because of my own choices (one's I mentioned in yesterday's blog) today's day was a complete waste, one which I barely utilised let alone optimise. As a result of sleeping at 1am last night, I got up at 10am today and started to code around 11:30. I coded till 2 during which period I finished a section on Numbers and Dates, I learnt about dates today and realised how less I know about them. I have previously worked with dates on this website (landing page) and even though today's lectures seemed familar they taught me a lot. I learnt about unix timestamp, ISO methods, other methods and ways to work with dates efficiently. I even fixed a small inaccuracy in my website's countdown timer and everything is fine now.<br><br>So why was today a waste, because today was a holiday and I could have done so much more today. I could have finished my assignments, studied for my classes, probably gone to the pool and managed coding with all of this. These were all part of the list of priorities I made yesterday, and while I wish to do some bit of everything each day, I was only able to code today. Anyways I'm off to play garba (for the first time) with my family at a relative's birthday party, they've even called a professional to teach us, but never am I ever going to let anyone else dicate my course of actions. I have learnt this the hard way.</p>`,
//   },
...
//   {
//     id: 35,
//     dateStr: `16<sup>th</sup> October '24`,
//     content: `<p>Someones making progress, progress he's proud of and confident that it leads him to the right path. The past few days haven't been the best for me in terms of coding, time management and multiple other things. However I'm super proud of the fact that I didn't give up and kept going however little I could and finally have figured things out. The key lies in getting appropriate rest at the right time. Over the past days I would come from college, while away time for an hour or two and then take a nap. Instead all I need to do is take a nap as soon as I reach home. This will hopefully work and give me enough time to get my work done. I have also come to realise that I don't have any time at home for assignments. The best thing I can do is finish them in college itself on the days they are assigned and in the breaks I get. In this way I'll be able to avoid things getting piled up and will be able to focus on more important things.<br><br>Today I had a lecture on C programming and a practical lab for it as well. I was able to complete all assigned work to me in the lab before time (coding), help my friends and also get a decent amount of coding done during my programming lecture. This involved understanding some patterns and nested for loop logic which was surprisingly helpful. I actually felt as if I learnt something new and this was more than enough to complete my coding quota for the day. I came home and just slept because I knew I had to get up and finish my electronics assignment. It was while solving this assignment that all this came to me and it is honestly all because of the small things I have involuntarily learnt during the past few days. This has in someway improved my time management and has actually also given me perspective. The perspective part is something which is a topic for a whole other blog but yes, I am back in full form and super pumped to start implementing my theories. If they work I'll be happy but if they don't I'll be happier, because then I'll know for sure that there is still a lot more to learn and improve upon!</p>`,
//   },

//   {
//     id: 36,
//     dateStr: `17<sup>th</sup> October '24`,
//     content: `<p>Well looks like my theory needs to be worked on. Yesterday I came to a conclusion that provided I get a short nap after coming home from college I should be able to get my work done. While that is partially true, its also a lot harder to do multiple things after that nap. It just makes more sense to focus on one thing which shouldn't be a problem. Something similar happened with me today. After getting up from my nap I was so confused with what to start with that I eventually ended up wasting a lot of time. The solution to this is making a realistic goal before the day starts and then finishing it properly. Glammy if you're reading this, no your grandson isn't over analysing, and no he isn't overthinking. Right now I have some breathing room to fine tune myself and that's all I'm trying to do. So hopefully setting my daily goals in addition to catching a nap should be enough to make things work.<br><br>Again even though I couldn't get work done today, I managed to get my mechanics drawings (part of my journal) figured out in college and code a little in the evening. For the coding part I implemented event delegation and was luckily able to get it right. I definitely need to learn more about it before getting the hang of it which is something I'm planning to do tomorrow. So tomorrow's goals are clear, I will complete a draft for my communications class presentation (in college), try solving a good amount of maths once I get home, and will try to understand event delegation better. Vamos!!</p>`,
//   },
